...
[`block`](https://cdn.jsdelivr.net/gh/PetrichorA/filter-4400e6cd@main/block.txt) 是基于域名的全站屏蔽，[`filter`](https://cdn.jsdelivr.net/gh/PetrichorA/filter-4400e6cd@main/filter.txt) 用来屏蔽弹窗和一些奇奇怪怪的JavaScript / CSS / 图片。

[`block`](https://cdn.jsdelivr.net/gh/PetrichorA/filter-4400e6cd@main/block.txt) 会和Peter Lowe的[屏蔽规则](https://pgl.yoyo.org/adservers/) :backup[https://archive.is/jca7Z] 不定期同步，并且加入了我浏览网页时碰到的广告域名 / 跟踪域名。不定期使用*神秘脚本*去除已经 `NXDOMAIN` 的域名。

项目托管在 [GitHub](https://github.com/PetrichorA/filter-4400e6cd) :backup[https://archive.is/1kr8z] 上，为了*闷声发大财*，没有写简介，也没有写README。
