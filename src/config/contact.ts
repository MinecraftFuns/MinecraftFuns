 ...
 *
 * A plaintext address is absent: correspondence goes through the PGP Primary
 * User ID. The fingerprint is not written down here either; it is read from the
 * key, so rotating the key cannot leave a stale one printed in the footer.
 */
